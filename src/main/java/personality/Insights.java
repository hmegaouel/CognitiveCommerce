...
public class Insights {
     ...
     */
    public Insights(String user) throws JSONException {
    ...
    public void addTweet(String body, Long dat, String id, String lang) throws JSONException {
    ...
    public void setScores() throws JSONException {
